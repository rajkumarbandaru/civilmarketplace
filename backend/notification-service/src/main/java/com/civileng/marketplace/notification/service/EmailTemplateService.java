...
public class EmailTemplateService {
    ...
    private static final List<BuiltIn> BUILT_INS = List.of(
            ...
            new BuiltIn("invitation-template", "Workspace owner invitation",
                    "Sent when a new workspace is published, inviting its owner to set a password.",
                    "You're invited to ${workspaceName}",
                    Map.of("name", "Anita Rao", "workspaceName", "Acme Builders",
                            "link", "https://acme.example.com/invite/sample", "expiresAt", "27 Sep 2026, 10:00 UTC")),
