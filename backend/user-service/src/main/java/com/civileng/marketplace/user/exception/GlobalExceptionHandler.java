package com.civileng.marketplace.user.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.civileng.marketplace.user.controller.AdminKycController.AccessDeniedException.class)
