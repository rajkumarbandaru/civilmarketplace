...
public class GlobalExceptionHandler {
    ...
    /** An invitation link that is unknown, used or expired; a user that does not exist. */
    ...
    /** More specific than the IllegalStateException handler below, which means rate limiting. */
