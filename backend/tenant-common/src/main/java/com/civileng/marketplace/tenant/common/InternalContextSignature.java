 ...
 *
 * <p>api-gateway keeps a byte-for-byte copy of this (it does not depend on tenant-common); both
 * test the same fixed vector, so a change to one without the other fails a build.
 */
